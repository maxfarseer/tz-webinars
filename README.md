*Внимание: репозиторий не содержит полного решения. Здесь содержится "рабочая версия" для третьего задания* (список всех заданий находится в [master](https://github.com/maxfarseer/tz-webinars/tree/master) ветке)
